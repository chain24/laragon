    ...
    <div class="col-md-2">
        ...
        @else
            @if(strtolower($user->gender) == 'male')
                <img src="{{asset('01-progress.gif')}}" data-src="{{asset('img/user.png')}}" class="img-thumbnail" width="100%">
            @else
                <img src="{{asset('01-progress.gif')}}" data-src="{{asset('img/user-female.png')}}" class="img-thumbnail" width="100%">
            @endif
        @endif
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-xs-3">
                                ...
                                @else
                                    @if(strtolower($user->gender) == 'male')
                                        <img src="{{asset('01-progress.gif')}}" data-src="{{asset('img/user.png')}}" class="img-thumbnail" id="my-profile" alt="Profile Picture" width="120px" height="120px">
                                    @else
                                        <img src="{{asset('01-progress.gif')}}" data-src="{{asset('img/user-female.png')}}" class="img-thumbnail" id="my-profile" alt="Profile Picture" width="120px" height="120px">
                                    @endif
                                @endif
                            </div>
                        </div>
