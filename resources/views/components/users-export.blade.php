@if(Auth::user()->role == 'admin')
    <link href="{{asset('css/bootstrap-datepicker-master/css/bootstrap-datepicker.min.css')}}"
          rel="stylesheet">
    <script src="{{asset('js/bootstrap-datepicker-master/js/bootstrap-datepicker.min.js')}}"></script>
    <div class="well">
